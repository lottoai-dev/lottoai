  ...
  if (!loading && draws.length === 0)
    return (
      <EmptyState
        ...
        desc="Bu oyun için sisteme henüz çekiliş sonucu girilmemiş. Haftalık takvimden çekiliş günlerini görebilirsin."
        action="Yenile"
  ...
  return (
    <View>
      ...
      {draws.slice(1).map((draw) => {
        ...
        return (
          <PressableScale key={draw.id} onPress={() => toggle(draw.id)} style={s.historyCard}>
